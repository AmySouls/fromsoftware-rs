...
impl BlockId {
    ...
    /// Returns true if this block ID refers to a small base map (Nightreign-specific).
    /// TODO: determine the actual area code(s) for small bases.
    pub fn is_small_base_map(&self) -> bool {
        false
    }
}
